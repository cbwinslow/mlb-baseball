...
## ADR-255: Plan 01F-R5 — two remaining `serve.*` views fanned out on repeated `gold.prediction` snapshots; workflow-lock cross-stage coverage gap closed
