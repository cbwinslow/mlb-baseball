...
| --- | --- | --- | --- | --- | --- |
| OFF-01 team prior OBP | game-team; `(H+BB+HBP)/(AB+BB+HBP+SF)` | Retrosheet/API events before game cutoff | NULL below denominator/min-sample; measure historical eras | no current-game PA; hand fixture and future-event exclusion | now / low — core formula implemented, `team_rate.py` (ADR-061); min-sample floor and historical-era coverage measurement outstanding, only the `> 0` denominator guard landed (github.com/cbwinslow/mlb-baseball/issues/8) |
