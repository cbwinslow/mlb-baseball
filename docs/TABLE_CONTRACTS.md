...
| Starter, bullpen, framing, OAA, speed, WAR, team-rate/run-environment families | Game-team or game-player feature family | Must be point-in-time/no-leakage as documented by the individual feature | Remain Python-owned until a narrow named SQL model has exact full/sampled tie-out |
