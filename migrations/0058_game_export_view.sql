...
SELECT
    ...
    f.game_date,
    f.game_number,
    ht.city || ' ' || ht.nickname AS home_team,
    at.city || ' ' || at.nickname AS away_team,
    ...
    f.home_rest,
    f.away_rest,
    hsp.first_name || ' ' || hsp.last_name AS home_starter,
    asp.first_name || ' ' || asp.last_name AS away_starter,
    f.home_starter_era,
    f.away_starter_era,
