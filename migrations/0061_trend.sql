...
-- main: BSR-01 took migration 0059, INT-01 took migration 0060/ADR-082,
-- both real and merged as of this rebase. The view below extends
-- 0060_int_diff.sql's real current tail (...wrc_plus_diff) directly.
