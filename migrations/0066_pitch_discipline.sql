-- Plate discipline and pitch sequence metrics (ADR-089, admission queue PIT-07,
...
ALTER TABLE gold.game_feature ADD COLUMN home_starter_csw_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_starter_csw_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN home_starter_whiff_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_starter_whiff_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN home_starter_fstrike_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_starter_fstrike_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN home_bullpen_csw_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_bullpen_csw_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN home_bullpen_whiff_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_bullpen_whiff_pct numeric;

-- Extend the research export view (0058_game_export_view.sql) with the
-- new columns, appended at the end of the SELECT list.
