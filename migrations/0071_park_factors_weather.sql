-- Multi-Year Component Park Factors & Environmental Weather Adjustments (PARK-01, WEA-01).
-- Provides multi-year 1/3/5-year run park factors, 3-year HR/2B/3B factors, platoon HR factors,
-- air density index, and effective center-field wind vector.

-- Component multi-year park factor columns
ALTER TABLE gold.game_feature ADD COLUMN park_factor_1yr numeric;
ALTER TABLE gold.game_feature ADD COLUMN park_factor_3yr numeric;
ALTER TABLE gold.game_feature ADD COLUMN park_factor_5yr numeric;
ALTER TABLE gold.game_feature ADD COLUMN park_hr_factor_3yr numeric;
ALTER TABLE gold.game_feature ADD COLUMN park_2b_factor_3yr numeric;
ALTER TABLE gold.game_feature ADD COLUMN park_3b_factor_3yr numeric;
ALTER TABLE gold.game_feature ADD COLUMN park_lhb_hr_factor_3yr numeric;
ALTER TABLE gold.game_feature ADD COLUMN park_rhb_hr_factor_3yr numeric;

-- Environmental and weather columns
ALTER TABLE gold.game_feature ADD COLUMN air_density_index numeric;
ALTER TABLE gold.game_feature ADD COLUMN effective_wind_speed numeric;
ALTER TABLE gold.game_feature ADD COLUMN wind_direction_label text;
