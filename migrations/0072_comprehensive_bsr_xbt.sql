-- Comprehensive BsR, Extra Bases Taken (XBT%), UBR, and wGDP metrics (RUN-01).
-- Expands gold.game_feature with advanced baserunning metrics and updates gold.game_export view.

ALTER TABLE gold.game_feature ADD COLUMN home_xbt_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_xbt_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN home_ubr_runs numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_ubr_runs numeric;
ALTER TABLE gold.game_feature ADD COLUMN home_wgdp_runs numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_wgdp_runs numeric;
ALTER TABLE gold.game_feature ADD COLUMN home_bsr_total numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_bsr_total numeric;
