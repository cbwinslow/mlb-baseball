...
-- Adds starting catcher framing metrics to gold.game_feature and updates gold.game_export view.

ALTER TABLE gold.game_feature ADD COLUMN home_catcher_csae_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_catcher_csae_pct numeric;
ALTER TABLE gold.game_feature ADD COLUMN home_catcher_framing_runs numeric;
ALTER TABLE gold.game_feature ADD COLUMN away_catcher_framing_runs numeric;
