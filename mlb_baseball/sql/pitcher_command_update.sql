...
-- Bullpen command aggregates per team
bullpen_daily AS (
    SELECT
        rg.game_id,
        rg.season,
...
SET
    home_starter_heart_pct = hs.heart_pct,
    away_starter_heart_pct = as_p.heart_pct,
    home_starter_shadow_pct = hs.shadow_pct,
    away_starter_shadow_pct = as_p.shadow_pct,
    home_starter_chase_pct = hs.chase_pct,
    away_starter_chase_pct = as_p.chase_pct,
    home_starter_fastball_velo = hs.fastball_velo,
    away_starter_fastball_velo = as_p.fastball_velo,
    home_starter_velo_delta = hs.velo_delta,
    away_starter_velo_delta = as_p.velo_delta,
    home_bullpen_heart_pct = hb.bp_heart_pct,
    away_bullpen_heart_pct = ab.bp_heart_pct,
    home_bullpen_shadow_pct = hb.bp_shadow_pct,
    away_bullpen_shadow_pct = ab.bp_shadow_pct,
    home_bullpen_chase_pct = hb.bp_chase_pct,
    away_bullpen_chase_pct = ab.bp_chase_pct
FROM regular_games rg
