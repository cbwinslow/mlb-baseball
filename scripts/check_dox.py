...
_IGNORED_PARTS = {
    ...
    "__pycache__",
    "node_modules",
    # Git worktrees under .claude/worktrees/ (or another agent tool's own
    # worktrees/ dir, e.g. .kilo/) each hold a full checkout of the repo,
    # including its own AGENTS.md/*.dox.md tree -- scanning into them
