...
_IGNORED_PARTS = {
    ...
    "__pycache__",
    "node_modules",
    # Git worktrees under .claude/worktrees/ or .kilo/worktrees/ each hold a
    # full checkout of the repo, including its own AGENTS.md/*.dox.md tree --
    # scanning into them double-counts every DOX file and reports spurious
    # "not listed in parent index" errors against the worktree's own root.
    ".claude",
    ".kilo",
