...
def _reset(db_conn):
    ...
    # _ensure_mlb_schedule_table above already recreates it fresh with the
    # correct columns on demand, so a DROP here is safe and prevents a
    # stale, differently-shaped schema from an earlier test/file
