...
SELECT
    rg.game_id,
    hs.fastball_ivb_in AS home_starter_fastball_ivb_in,
    as_p.fastball_ivb_in AS away_starter_fastball_ivb_in,
    hs.curve_drop_in AS home_starter_curve_drop_in,
    as_p.curve_drop_in AS away_starter_curve_drop_in,
    hs.vert_separation_in AS home_starter_vert_separation_in,
    as_p.vert_separation_in AS away_starter_vert_separation_in,
    hs.spin_rate_rpm AS home_starter_spin_rate_rpm,
    as_p.spin_rate_rpm AS away_starter_spin_rate_rpm,
    hb.bp_vert_separation_in AS home_bullpen_vert_separation_in,
    ab.bp_vert_separation_in AS away_bullpen_vert_separation_in,
    hbt.bat_chase_pct AS home_batting_chase_pct,
    abt.bat_chase_pct AS away_batting_chase_pct,
    hbt.bat_heart_swing_pct AS home_batting_heart_swing_pct,
    abt.bat_heart_swing_pct AS away_batting_heart_swing_pct
FROM regular_games rg
