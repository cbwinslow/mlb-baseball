MODEL (
    name gold.team_bsr_comprehensive,
    kind FULL,
    cron '@daily',
    grain [game_id]
);
...
SELECT
    rg.game_id,
    wh.sb_sum AS home_sb,
    wa.sb_sum AS away_sb,
    wh.cs_sum AS home_cs,
    wa.cs_sum AS away_cs,
    wh.wsb AS home_wsb,
    wa.wsb AS away_wsb,
    wh.xbt_pct AS home_xbt_pct,
    wa.xbt_pct AS away_xbt_pct,
    wh.ubr_runs AS home_ubr_runs,
    wa.ubr_runs AS away_ubr_runs,
    wh.wgdp_runs AS home_wgdp_runs,
    wa.wgdp_runs AS away_wgdp_runs,
    wh.bsr_total AS home_bsr_total,
    wa.bsr_total AS away_bsr_total
FROM regular_games rg
